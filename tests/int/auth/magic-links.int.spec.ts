...
describe('Magic Links', () => {
  ...
  describe('Token Validation', () => {
    it('should validate valid magic link token', async () => {
      const { generateMagicLinkToken, validateMagicLinkToken } = await import(
        '@/lib/auth/magic-links'
      )
    ...
    it('should invalidate token after use', async () => {
      const { generateMagicLinkToken, validateMagicLinkToken, consumeMagicLinkToken } =
        await import('@/lib/auth/magic-links')
  ...
  describe('Magic Link Flow', () => {
    it('should complete full magic link flow', async () => {
      const { initiateMagicLinkFlow, completeMagicLinkFlow } = await import(
        '@/lib/auth/magic-links'
      )
